...
class UserSharedSymfonyProviderAdapter implements UserProviderInterface
{
    ...
    public function loadUserByIdentifier(string $identifier): UserInterface
    {
        try {
            ...
            throw new UserNotFoundException('Identifier not found: ', $identifier.' - getMessage:'.$e->getMessage().' - GetMessagePrevious'.$e->getPrevious()->getMessage().'- GetMessagePrevious 2:'.$e->getPrevious()->getPrevious()->getMessage());
        }
    }
