    ...
    public function image(
        ...
        return $this->createConstraint(
            ...
            [
                ...
                Image::FILENAME_TOO_LONG => VALIDATION_ERRORS::FILE_NAME_TOO_LONG,
                ...
                Image::TOO_LARGE_ERROR => VALIDATION_ERRORS::FILE_IMAGE_TOO_LARGE,
                Image::TOO_NARROW_ERROR => VALIDATION_ERRORS::FILE_IMAGE_TOO_NARROW,
                Image::TOO_WIDE_ERROR => VALIDATION_ERRORS::FILE_IMAGE_TOO_WIDE,
                Image::TOO_LOW_ERROR => VALIDATION_ERRORS::FILE_IMAGE_TOO_LOW,
                Image::TOO_HIGH_ERROR => VALIDATION_ERRORS::FILE_IMAGE_TOO_HIGH,
                Image::TOO_FEW_PIXEL_ERROR => VALIDATION_ERRORS::FILE_IMAGE_TOO_FEW_PIXEL,
                Image::TOO_MANY_PIXEL_ERROR => VALIDATION_ERRORS::FILE_IMAGE_TOO_MANY_PIXEL,
                Image::RATIO_TOO_SMALL_ERROR => VALIDATION_ERRORS::FILE_IMAGE_RATIO_TOO_SMALL,
                Image::RATIO_TOO_BIG_ERROR => VALIDATION_ERRORS::FILE_IMAGE_RATIO_TOO_BIG,
                Image::LANDSCAPE_NOT_ALLOWED_ERROR => VALIDATION_ERRORS::FILE_IMAGE_LANDSCAPE_NOT_ALLOWED,
                Image::PORTRAIT_NOT_ALLOWED_ERROR => VALIDATION_ERRORS::FILE_IMAGE_PORTRAIT_NOT_ALLOWED,
                Image::SQUARE_NOT_ALLOWED_ERROR => VALIDATION_ERRORS::FILE_IMAGE_SQUARE_NOT_ALLOWED,
                Image::SIZE_NOT_DETECTED_ERROR => VALIDATION_ERRORS::FILE_IMAGE_SIZE_NOT_DETECTED,
                Image::CORRUPTED_IMAGE_ERROR => VALIDATION_ERRORS::FILE_IMAGE_CORRUPTED_IMAGE,
