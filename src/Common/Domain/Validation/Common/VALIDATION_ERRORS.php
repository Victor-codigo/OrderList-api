...
enum VALIDATION_ERRORS
{
    ...
    case FILE_USER_IMAGE_RATIO_TOO_SMALL;
    case FILE_USER_IMAGE_RATIO_TOO_BIG;
    case FILE_USER_IMAGE_TOO_NARROW;
    case FILE_USER_IMAGE_TOO_WIDE;
    case FILE_USER_IMAGE_TOO_LOW;
    case FILE_USER_IMAGE_TOO_HIGH;
    case FILE_USER_IMAGE_TOO_LARGE;
    case FILE_USER_IMAGE_TOO_FEW_PIXEL;
    case FILE_USER_IMAGE_TOO_MANY_PIXEL;
    case FILE_USER_IMAGE_LANDSCAPE_NOT_ALLOWED;
    case FILE_USER_IMAGE_PORTRAIT_NOT_ALLOWED;
    case FILE_USER_IMAGE_SQUARE_NOT_ALLOWED;
    case FILE_USER_IMAGE_SIZE_NOT_DETECTED;
    case FILE_USER_IMAGE_CORRUPTED_IMAGE;
