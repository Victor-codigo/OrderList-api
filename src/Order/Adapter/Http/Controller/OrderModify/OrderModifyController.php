            ...
            new OA\MediaType(
                ...
                schema: new OA\Schema(
                    properties: [
                        ...
                        new OA\Property(property: 'list_orders_id', type: 'string', description: 'List orders id', example: '0630d868-e1d5-4c17-84c8-002eb28f5bdb'),
            ...
            content: new OA\MediaType(
                ...
                schema: new OA\Schema(
                    properties: [
                        ...
                        new OA\Property(property: 'errors', type: 'array', items: new OA\Items(default: '<order_id|group_id|list_orders_id|product_id|shop_id|description|amount|list_orders_not_found|order_not_found|product_not_found|shop_not_found|order_product_and_shop_repeated|permissions, string|array>')),
                    ]
                )
            )
        ),
