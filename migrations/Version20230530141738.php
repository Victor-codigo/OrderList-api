...
final class Version20230530141738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Products_Shops (id BIGINT AUTO_INCREMENT NOT NULL, product_id CHAR(36) NOT NULL, shop_id CHAR(36) NOT NULL, price DECIMAL(10,2) DEFAULT NULL, unit CHAR(5) NOT NULL, INDEX IDX_product_id (product_id), INDEX IDX_shop_id (shop_id), UNIQUE INDEX u_id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
