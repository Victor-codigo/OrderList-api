...
final class Version20230530141738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Orders (id CHAR(36) NOT NULL, group_id CHAR(36) NOT NULL, list_orders_id CHAR(36) NOT NULL, product_id CHAR(36) NOT NULL, shop_id CHAR(36), user_id CHAR(36) NOT NULL,  description VARCHAR(500) DEFAULT NULL, amount DECIMAL(10,3) DEFAULT NULL, bought TINYINT(1) NOT NULL, created_on DATETIME NOT NULL, INDEX IDX_user_id (user_id), INDEX IDX_group_id (group_id), INDEX IDX_list_orders_id (group_id), INDEX IDX_product_id (product_id), INDEX IDX_shop_id (shop_id), UNIQUE INDEX u_order_id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
