 ...
 */
final class Version20220928093020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Users (id CHAR(36) NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(256) NOT NULL, name VARCHAR(50) NOT NULL, roles JSON NOT NULL, created_on DATETIME NOT NULL, activation_token CHAR(36) DEFAULT NULL, UNIQUE INDEX u_users_id (id), UNIQUE INDEX u_users_name (name), UNIQUE INDEX u_users_email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
