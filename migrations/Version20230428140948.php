 ...
 */
final class Version20230428140948 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Creates tables Orders, Products, Shops and Products_shops';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Products (id CHAR(36) NOT NULL, group_id CHAR(36) NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(500) DEFAULT NULL, image VARCHAR(256) DEFAULT NULL, created_on DATETIME NOT NULL, INDEX IDX_product_name (name), UNIQUE INDEX u_products_id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Shops (id CHAR(36) NOT NULL, group_id CHAR(36) NOT NULL, name VARCHAR(50) NOT NULL, price DECIMAL(10,2) NOT NULL, image VARCHAR(50) NOT NULL, description VARCHAR(500) DEFAULT NULL, created_on DATETIME NOT NULL, UNIQUE INDEX UNIQ_E2BB4887CAC822D9 (price), INDEX idx_shop_id (id), INDEX idx_shop_group_id (group_id), UNIQUE INDEX u_shops_id (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
