 ...
 */
final class Version20221006080343 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Users (id CHAR(36) NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(256) NOT NULL, name VARCHAR(50) NOT NULL, roles JSON DEFAULT NULL, created_on DATETIME NOT NULL, UNIQUE INDEX u_users_id (id), UNIQUE INDEX u_users_email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
