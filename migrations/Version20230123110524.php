...
final class Version20230123110524 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Users_Group (id BIGINT AUTO_INCREMENT NOT NULL, group_id CHAR(36) NOT NULL, user_id CHAR(36) NOT NULL, roles JSON NOT NULL, INDEX IDX_CDEA405FFE54D947 (group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE Users_Group ADD CONSTRAINT FK_CDEA405FFE54D947 FOREIGN KEY (group_id) REFERENCES `Groups` (id) ON DELETE CASCADE');
    }
