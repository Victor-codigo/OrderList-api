...
final class Version20230123110524 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE `Groups` (id CHAR(36) NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(500) DEFAULT NULL, type VARCHAR(50) NOT NULL, created_on DATETIME NOT NULL, UNIQUE INDEX UNIQ_F7C13C465E237E06 (name), UNIQUE INDEX u_groups_id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
