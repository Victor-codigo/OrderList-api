...
final class Version20230117181236 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE `Groups` (id CHAR(36) NOT NULL, name VARCHAR(50) NOT NULL, description TEXT, type VARCHAR(50) NOT NULL, created_on DATETIME NOT NULL, UNIQUE INDEX u_groups_id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
