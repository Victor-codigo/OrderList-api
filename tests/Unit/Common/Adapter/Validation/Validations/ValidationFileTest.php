    ...
    public function validationUserImageOk(): void
    {
        $return = $this->object
            ...
            ->image(
                ...
                self::IMAGE_DATA['heigthMin'],
                self::IMAGE_DATA['heigthMax'],
    ...
    public function validationUserImageFailLandscapeNotAllowed(): void
    {
        $return = $this->object
            ...
            ->image(
                ...
                self::LANDSCAPE_DATA['heigthMin'],
                self::LANDSCAPE_DATA['heigthMax'],
    ...
    public function validationUserImageFailPortraitNotAllowed(): void
    {
        $return = $this->object
            ...
            ->image(
                ...
                self::PORTRAIT_DATA['heigthMin'],
                self::PORTRAIT_DATA['heigthMax'],
