...
class EventDispatcherSymfonyAdapterTest extends TestCase
{
    ...
    public function addNewSubscriberWithManyMethodsDefined(): void
    {
        ...
        $this->eventDispatcher
            ...
            ->method('addListener')
            ->withConsecutive(
                [CustomEvent::class, [$subscriber, '__invoke'], 0],
                [CustomEvent::class, [$subscriber, 'handler'], 0],
                [CustomEvent::class, [$subscriber, 'handler'], 5],
                [CustomEvent::class, [$subscriber, 'execute'], 10],
                [CustomEvent::class, [$subscriber, 'exe'], 20],
            );
