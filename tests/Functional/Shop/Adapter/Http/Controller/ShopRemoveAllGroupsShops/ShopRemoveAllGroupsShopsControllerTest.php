...
class ShopRemoveAllGroupsShopsControllerTest extends WebClientTestCase
{
    ...
    private const ENDPOINT = '/api/v1/shops/group/remove-shops';
    ...
    private const GROUP_EXISTS_ID_NO_SHOPS = '0ae87143-9623-318c-8ea1-baaf24253f0f';
    private const SHOP_EXISTS_ID = [
